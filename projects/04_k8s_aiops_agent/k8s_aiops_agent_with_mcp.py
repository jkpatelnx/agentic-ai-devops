...
async def main():
    ...
    # 3. Create the agent
    k8s_aiops_agent_with_mcp = create_agent(llm_model,tools)
    ...
    print("[bold green]K8S AIOps Agent with MCP Started[/bold green]")
    ...
    while True:
        ...
        try:
            ...
            response = await k8s_aiops_agent_with_mcp.ainvoke(
                {
